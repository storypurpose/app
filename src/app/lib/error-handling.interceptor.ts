                ...
                err => {
                    if (err instanceof HttpErrorResponse) {
                        ...
                        if (err.status === 0) {
                            ...
                            this.messageService.add({ severity: 'info', summary: 'Requires authorization', detail: "Enter valid credentials to access module", life: 5000, closable: true, data: { showAuth: true } });
